function [] = total_displ(boundingBox1,rho,epsilon,M,type)
...
%     saveas(fig,['BoundingBox',num2str(i)],'jpeg');
    ...
    d_x0 = 0;
    d_y0 = 0;
    [d_x,d_y] = lk(I1_frame,I2_frame,rho,epsilon,d_x0,d_y0,M);
...
%     saveas(fig,['OpticalFlow-',num2str(i),'-',num2str(i+1)],'jpeg');
...
%     saveas(fig,['VectorsEnergy-',num2str(i),'-',num2str(i+1)],'jpeg');
